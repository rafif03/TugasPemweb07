...
<form action=" <?php echo e(route('pelanggan.update', $pelanggan->NoPelanggan)); ?>" method="post">
    <?php echo csrf_field(); ?>
    <?php echo method_field('PUT'); ?>
        <table class="table table-info table-hover table-striped">
            <tr>
                <td colspan="2"><h3>Edit Pelanggan no <?php echo e($pelanggan->NoPelanggan); ?></h3></td>
            </tr>
            <tr>
                <td>No Telp</td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\TugasPemweb07-copy\resources\views/pelanggan/edit.blade.php ENDPATH**/ ?>